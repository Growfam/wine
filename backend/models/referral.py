...
class Referral(db.Model):
    ...
    Attributes:
        ...
        referrer_id (str): ID користувача, який запросив (реферер)
        referee_id (str): ID користувача, якого запросили (реферал)
    ...
    __table_args__ = (
        UniqueConstraint('referee_id', name='uq_referee_id'),
    )
    ...
    def __init__(self, referrer_id, referee_id, level=1):
        ...
        Args:
            referrer_id (str): ID користувача-реферера
            referee_id (str): ID користувача-реферала
