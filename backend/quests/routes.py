...
def register_quests_routes(app):
    ...
    def api_get_user_tasks(telegram_id):
        ...
        return controllers.get_tasks_for_user(telegram_id)
    ...
    def api_get_task_status(telegram_id, task_id):
        ...
        return controllers.get_task_status(telegram_id, task_id)
    ...
    def api_start_task(telegram_id, task_id):
        ...
        return controllers.start_task(telegram_id, task_id)
    ...
    def api_update_task_progress(telegram_id, task_id):
        ...
        return controllers.update_task_progress(telegram_id, task_id)
    ...
    def api_verify_task(telegram_id, task_id):
        ...
        return controllers.verify_task(telegram_id, task_id)
    ...
    def api_get_user_progress(telegram_id):
        ...
        return controllers.get_user_progress(telegram_id)
    ...
    def api_claim_streak_bonus(telegram_id):
        ...
        return controllers.claim_streak_bonus(telegram_id)
    ...
    def api_get_bonus_history(telegram_id):
        ...
        return controllers.get_bonus_history(telegram_id)
    ...
    @app.route('/api/user/<telegram_id>/referral-code', methods=['GET'])
    def api_get_referral_code(telegram_id):
        """Отримання реферального коду користувача"""
        return controllers.get_referral_code(telegram_id)
    ...
    def api_get_user_referrals(telegram_id):
        ...
        return controllers.get_user_referrals(telegram_id)

    @app.route('/api/referrals/use-code', methods=['POST'])
