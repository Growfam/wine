...
class DictLoader(BaseLoader):
    ...
    >>> loader = DictLoader({'original-index.html': 'source here'})
...
class PrefixLoader(BaseLoader):
    ...
    By loading ``'app1/original-index.html'`` the file from the app1 package is loaded,
    by loading ``'app2/original-index.html'`` the file from the second.
    """
