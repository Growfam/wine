/**
 * Утилітарні функції для роботи з UI
 */
...
(function() {
    ...
    function markElement(container, text = 'ОТРИМАНО') {
        if (!container) return;
    ...
    // Експортуємо UI-хелпери
    window.WinixRaffles.utils = window.WinixRaffles.utils || {};
    window.WinixRaffles.utils.showLoading = showLoading;
    window.WinixRaffles.utils.hideLoading = hideLoading;
    window.WinixRaffles.utils.showToast = showToast;
    window.WinixRaffles.utils.markElement = markElement;
})();