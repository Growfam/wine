...
(function() {
    ...
    if (typeof window.WinixRaffles === 'undefined') {
        console.error('❌ WinixRaffles не знайдено! Переконайтеся, що core.js підключено раніше formatters.js');
        return;
    }
    ...
    const formatters = {
        ...
        formatEndTime: function(endDate) {
            ...
            const tomorrow = new Date(now);
            tomorrow.setDate(now.getDate() + 1);
            if (end.getDate() === tomorrow.getDate() &&
        ...
        ensureDate: function(date) {
            ...
            if (typeof date === 'number') {
                ...
                if (date < 10000000000) { // Якщо це секунди (до 2286 року)
