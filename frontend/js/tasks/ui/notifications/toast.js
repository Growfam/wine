...
import { CONFIG, injectStyles, ensureContainer } from 'js/tasks/ui/notifications/common.js';
...
export function showNotification(message, type = 'info', callback = null, options = {}) {
  ...
  return new Promise((resolve) => {
    ...
    try {
      ...
      const notification = createNotificationElement(notificationId, type, title, message);
